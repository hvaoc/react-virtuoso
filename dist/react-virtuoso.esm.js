...
var VirtuosoStore = function VirtuosoStore(_ref) {
  ...
  list$.pipe(withLatestFrom(adjustmentInProgress$), filter(function (_ref2) {
    ...
    var _ref3$ = _ref3[0],
        startIndex = _ref3$[0].index,
        length = _ref3$.length,
        endIndex = _ref3$[length - 1].index;
    console.log('What to get', {
      startIndex: startIndex,
      endIndex: endIndex
    });
    return {
...
forwardRef(function (props, ref) {
  ...
  }, [state, props.endReached, props.rangeChanged, props.atBottomStateChange, props.scrollingStateChange, props.groupCounts, props.groupIndices, props.itemsRendered, props.totalListHeightChanged, props.item, props.group, props.GroupContainer, props.ItemContainer]);
  return React.createElement(VirtuosoPresentation, {
    contextValue: state,
    style: props.style,
    className: props.className,
